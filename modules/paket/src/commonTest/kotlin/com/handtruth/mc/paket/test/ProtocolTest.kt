...
class ProtocolTest {
    ...
    class ExamplePaket(
        ...
        var pInt16 by int16(pInt16)
        var pInt32 by int32(pVarInt)
        var pInt64 by int64(pInt64)
        var pUInt8 by uint8(pInt8.toUByte())
        var pUInt16 by uint16(pInt16.toUShort())
        var pUInt32 by uint32(pVarInt.toUInt())
        var pUInt64 by uint64(pInt64.toULong())

        var pSZ32: Int by zint(pVarInt)
        var pSZ64: Long by zint(pInt64)
        var pUZ32: UInt by zint(pVarInt.toUInt())
        var pUZ64: ULong by zint(pInt64.toULong())
